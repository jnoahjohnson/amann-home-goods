      ...
      <div className="relative bg-gray-900">
        ...
        <header className="relative z-10">
          <nav aria-label="Top">
            ...
            <div className="backdrop-blur-md backdrop-filter bg-slate-100">
                ...
                <div>
                  <div className="h-16 flex items-center justify-between">
                    ...
                    <div className="hidden lg:flex-1 lg:flex lg:items-center">
                      <a href="#">
                        <span className="sr-only">Amann Home Goods</span>
                        <img
                              ...
                              {({ open }) => (
                                <>
                                  <div className="relative flex">
                                    <Popover.Button className="relative z-10 flex items-center justify-center transition-colors ease-out duration-200 text-sm font-medium text-gray-800">
                                      {category.name}
                                      <span
                                  ...
                                  <Transition
                                    ...
                                    leaveTo="opacity-0"
                                  >
                                    <Popover.Panel className="absolute top-full inset-x-0 text-sm text-gray-800">
